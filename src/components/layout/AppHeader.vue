<template>
  <header
    class="sticky top-0 flex w-full bg-gradient-jobb border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b"
  >
    <div class="flex flex-col items-center justify-between flex-grow lg:flex-row lg:px-6">
      ...
      >
        <button
          @click="handleToggle"
          class="flex items-center justify-center w-10 h-10 text-white hover:text-black border-none hover:bg-white-500 rounded-lg z-99999 lg:h-11 lg:w-11 lg:border"
          :class="[
            isMobileOpen
